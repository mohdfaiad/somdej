...
type
  TfrmMsSetupAccountTextGrid = class(TMainGridForm)
    dsgrid: TDataSource;
    UniLabel3: TUniLabel;
...
var
  frmMsSetupAccountTextGrid: TfrmMsSetupAccountTextGrid;

implementation

{$R *.dfm}

uses uniGUIForm, MsSetupAccountTextDataForm;


procedure TfrmMsSetupAccountTextGrid.btnAddClick(Sender: TObject);
var
  _Form: TUniForm;
begin
  _Form := TUniFormClass(TfrmMsSetupAccountTextData).Create(UniApplication);
//  TfrmMsSetupAccountTextData(_Form).Init(DM,dm.CdsGetConListCONTRACT_ID.AsLargeInt);
