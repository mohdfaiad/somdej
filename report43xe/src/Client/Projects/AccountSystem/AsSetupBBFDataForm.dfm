inherited frmAsSetupBBFData: TfrmAsSetupBBFData
  Caption = #3610#3633#3609#3607#3638#3585#3618#3629#3604#3618#3585#3617#3634#3605#3657#3609#3591#3623#3604#3591#3610#3607#3604#3621#3629#3591
  ClientHeight = 518
  ClientWidth = 933
  Position = poDesigned
  ExplicitWidth = 933
  ...
  inherited pnHeader: TUniPanel
    ...
    object UniCheckBox4: TUniCheckBox
      ...
      Height = 17
      Checked = False
      Caption = #3610#3633#3597#3594#3637#3592#3619#3636#3591
      TabOrder = 5
    end
    ...
    object UniRadioGroup4: TUniRadioGroup
      ...
      Height = 75
      Items.Strings = (
        #3591#3610#3604#3640#3621
        #3591#3610#3585#3635#3652#3619#3586#3634#3604#3607#3640#3609)
      ItemIndex = -1
      Align = alCustom
      Caption = #3611#3619#3632#3648#3616#3607#3591#3610
      TabOrder = 9
    end
