...
type
  TfrmAsSetupAccGrid = class(TMainGridForm)
    dsgrid: TDataSource;
    UniLabel3: TUniLabel;
...
var
  frmAsSetupAccGrid: TfrmAsSetupAccGrid;

implementation

{$R *.dfm}

uses uniGUIForm, AsSetupAccDataForm;


procedure TfrmAsSetupAccGrid.btnAddClick(Sender: TObject);
var
  _Form: TUniForm;
begin
  _Form := TUniFormClass(TfrmAsSetupAccData).Create(UniApplication);
