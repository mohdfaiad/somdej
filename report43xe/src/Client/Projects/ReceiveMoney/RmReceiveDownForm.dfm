inherited frmRmReceiveDownGrid: TfrmRmReceiveDownGrid
  Caption = #3585#3634#3619#3619#3633#3610#3648#3591#3636#3609#3604#3634#3623#3609#3660#3588#3591#3588#3657#3634#3591
  ClientHeight = 650
  ClientWidth = 931
  Position = poDesigned
  ...
  inherited pnBody: TUniPanel
    ...
    object dbgDataList: TUniDBGrid
      ...
      Columns = <
        ...
        item
          Title.Alignment = taCenter
          Title.Caption = #3648#3591#3636#3609#3604#3634#3623#3609#3660#3588#3591#3588#3657#3634#3591
          Width = 84
          Visible = True
          Expanded = False
        end
        ...
        item
          Title.Alignment = taCenter
          Title.Caption = #3592#3656#3634#3618#3650#3604#3618
          Width = 64
          Visible = True
          Expanded = False
        end
        item
          Title.Alignment = taCenter
          Title.Caption = #3648#3621#3618#3607#3637#3656#3648#3594#3655#3588
          Width = 64
          Visible = True
          Expanded = False
        end
