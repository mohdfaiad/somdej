...
type
  TfrmRmReceiveMoneyDataT = class(TMainDataForm)
    LbDnort4: TUniLabel;
    PnHeadRt4: TUniPanel;
    Lbidtrt4: TUniLabel;
    PnDtl1: TUniPanel;
...
var
  frmRmReceiveMoneyDataT: TfrmRmReceiveMoneyDataT;
...
uses PopupCsmForm, PopupApForm, Math, PopupArForm,
   PopupAddressForm, PopupRcvMoneyForm, PopupRcvAm4Form;


Procedure TfrmRmReceiveMoneyDataT.PrintReport(_Sql_Txt : String);
var
...
procedure TfrmRmReceiveMoneyDataT.PTPRT4CloseUp(Sender: TObject);
begin
  PnDtl3.Visible := (Fdm.CdsTtRcvGetPTPRT4.AsString  = 'P');

end;

procedure TfrmRmReceiveMoneyDataT.ShowEdtAmtAndDate();
begin
...
procedure TfrmRmReceiveMoneyDataT.GetAddr(cno : int64);
begin
...
procedure TfrmRmReceiveMoneyDataT.GetAm4;
begin
  // FG  N in is program call AM1 in pl
  if FG = 'N' then
    FDCD := '115'
  else if FG = 'R' then
    FDCD := '102';
...
procedure TfrmRmReceiveMoneyDataT.GetRt4;
begin
...
procedure TfrmRmReceiveMoneyDataT.GetGt1;
begin
...
procedure TfrmRmReceiveMoneyDataT.CustomerSelected(CCNCSM:int64;TNMCSM:String);
begin
...
procedure TfrmRmReceiveMoneyDataT.btnCancelClick(Sender: TObject);
begin
...
procedure TfrmRmReceiveMoneyDataT.btnConfirmClick(Sender: TObject);
...
procedure TfrmRmReceiveMoneyDataT.checkCur(Sender: TObject;CdsTmp : TClientDataSet);
var
  cur : Currency;
  F: TField;
  Str,Tmp : String;
...
procedure TfrmRmReceiveMoneyDataT.AMTRT4Exit(Sender: TObject);
begin
  checkCur(AMTRT4,fdm.CdsTtRcvGet);

end;

procedure TfrmRmReceiveMoneyDataT.AMTRT4KeyPress(Sender: TObject; var Key: Char);
begin
  if key = #13 then
  begin
    key := #0;
...
procedure TfrmRmReceiveMoneyDataT.CallSumAmtRt4();
var SumAmt : Double;
begin
  SumAmt := 0;
...
procedure TfrmRmReceiveMoneyDataT._SumAmtRt4(SumAmtRt4 : Double);
begin
...
procedure TfrmRmReceiveMoneyDataT.BtnAddRt4Click(Sender: TObject);
begin
...
procedure TfrmRmReceiveMoneyDataT._Confirm(AResult: Integer);
begin
  case AResult of
...
procedure TfrmRmReceiveMoneyDataT.BtnDeleteRt4Click(Sender: TObject);
begin
...
procedure TfrmRmReceiveMoneyDataT.BtnPrintClick(Sender: TObject);
var Str_Sql : String;
begin
   Str_Sql :='SELECT * FROM SP_REP_RM_RCV_MONEY(' +
              Fdm.CdsTtRcvGetYARRT4.AsString + ',' +
...
procedure TfrmRmReceiveMoneyDataT.GetAddrAr(cno : String);
begin
  FCarSaledm.CdsMtCsmGetAddr01.Close();
...
procedure TfrmRmReceiveMoneyDataT.FinanceSelected(CNOCM1,TNMCM1,CTPCM1,SMNCM1 : String;CRTAM3 : INTEGER);
begin
...
procedure TfrmRmReceiveMoneyDataT.BtnSelectCSMorVMClick(Sender: TObject);
begin

  if fdm.CdsTtRcvGetCTYRT4.AsString = '2' then  // บุคคลธรรมดา
  begin
...
procedure TfrmRmReceiveMoneyDataT.Init(DM : TDSReceiveMoneyDM; _FG : STRING);
begin
