inherited frmRmReceiveMoneyData: TfrmRmReceiveMoneyData
  ...
  inherited pnFooter: TUniPanel
    ...
    DesignSize = (
      1187
      37)
    inherited btnCancel: TUniButton [0]
      Tag = 1
      Left = 1105
      ExplicitLeft = 1105
    end
    inherited btnConfirm: TUniButton [1]
      Left = 1024
      ExplicitLeft = 1024
    end
    inherited btnBack: TUniButton [2]
    end
    inherited imgBotton: TUniImage [3]
      Width = 1187
      Picture.Data = {
  ...
  object dsRcvGetAm4: TDataSource
    Left = 24
    Top = 336
  end
