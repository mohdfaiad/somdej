...
begin
  ...
  begin
    fdm.MtAppGetList('--','',FDM.CMPUser,FDM.BRNUser,'',Now,Now,'N');
  ...
  Fdm.CdsMtAppGetNLEOT5.AsInteger := 48;
  ...
  Fdm.CdsMtAppGetESDOT5.AsInteger := 1;
...
begin
 ...
 if Trim(ITO.Text) = '' then
    ...
    IF not(FDM.MtAppGetList(cirt,order,EdtCom.Text,EdtBrn.Text,EdtDEP.Text,V_FRM,V_TO,'N')) THEN
