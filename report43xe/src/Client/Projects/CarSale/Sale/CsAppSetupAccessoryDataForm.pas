...
procedure TfrmCsAppSetupAccessoryData.GetAddrAr(cno : String);
begin
  Fdm.CdsMtCsmGetAddr01.Close();
...
begin
  ...
  Fdm.MtAppGetAccessory(fdm.CdsSetupAccessoryGetListYAROM3.AsInteger,fdm.CdsSetupAccessoryGetListCMPOM3.AsString,
               fdm.CdsSetupAccessoryGetListBRNOM3.AsString,App_DCD,fdm.CdsSetupAccessoryGetListDNOOT5.AsInteger,'S');
...
procedure TfrmCsAppSetupAccessoryData.ApplicationSelected(YAR:Integer;CMP,BRN,DCD:String;DNO : Integer;app_sts:integer;APPR_TEXT:string);
begin
...
var RecNo : integer;
begin
  if Fdm.CdsSetupAccessoryGetListVNOOM3.AsString = '' then
  begin
    ShowMessage('กรุณาเลือกผู้จัดจำหน่าย');
    exit;
  end;
  if Fdm.CdsSetupAccessoryGetListTWHOM3.AsString = '' then
  begin
    ShowMessage('กรุณาเลือกคลังสินค้าที่รับเข้า');
    exit;
  end;
  ...
  begin
     ...
     begin
       ...
       // Fdm.CdsSetupAccessoryGetrsqom3.AsInteger := Fdm.CdsMtAppGetSEQOT5.AsInteger;
        Fdm.CdsSetupAccessoryGetrsqom3.AsInteger := Fdm.CdsMtAppGetAccessorySEQOT6.AsInteger;
...
//        Fdm.CdsSetupAccessoryGetnteom3.AsString := '';
        ...
        Fdm.CdsMtAppGetAccessory.delete();
     end
     else
