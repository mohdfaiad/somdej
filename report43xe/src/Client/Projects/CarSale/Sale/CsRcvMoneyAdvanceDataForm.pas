...
procedure TfrmCsRcvMoneyAdvanceData.ShowEdtAmtAndDate();
begin
...
Procedure TfrmCsRcvMoneyAdvanceData.PrintReport(_Sql_Txt : String);
var
...
procedure TfrmCsRcvMoneyAdvanceData.PTPRT4CloseUp(Sender: TObject);
begin
  PnDtl3.Visible := (Fdm.CdsTtRcvGetPTPRT4.AsString  = 'P');

end;

procedure TfrmCsRcvMoneyAdvanceData.UniFormCreate(Sender: TObject);
begin
  inherited;
  FG := 'N';
end;

procedure TfrmCsRcvMoneyAdvanceData.GetAm4;
begin
...
procedure TfrmCsRcvMoneyAdvanceData.GetRt4;
begin
...
procedure TfrmCsRcvMoneyAdvanceData.GetGt1;
begin
...
procedure TfrmCsRcvMoneyAdvanceData.CustomerSelected(CCNCSM:int64;TNMCSM:String);
begin
...
procedure TfrmCsRcvMoneyAdvanceData.btnCancelClick(Sender: TObject);
begin
...
procedure TfrmCsRcvMoneyAdvanceData.btnConfirmClick(Sender: TObject);
...
procedure TfrmCsRcvMoneyAdvanceData.checkCur(Sender: TObject;CdsTmp : TClientDataSet);
var
  cur : Currency;
  F: TField;
  Str,Tmp : String;
...
procedure TfrmCsRcvMoneyAdvanceData.AMTRT4Exit(Sender: TObject);
begin
  checkCur(AMTRT4,fdm.CdsTtRcvGet);

end;

procedure TfrmCsRcvMoneyAdvanceData.AMTRT4KeyPress(Sender: TObject; var Key: Char);
begin
  if key = #13 then
  begin
    key := #0;
...
procedure TfrmCsRcvMoneyAdvanceData.CallSumAmtRt4();
var SumAmt : Double;
begin
  SumAmt := 0;
...
procedure TfrmCsRcvMoneyAdvanceData._SumAmtRt4(SumAmtRt4 : Double);
begin
...
procedure TfrmCsRcvMoneyAdvanceData.BtnAddRt4Click(Sender: TObject);
begin
...
procedure TfrmCsRcvMoneyAdvanceData._Confirm(AResult: Integer);
begin
  case AResult of
    mrYes:
    begin
       fdm.CdsTtRcvGetAm4.Filtered := False;

       fdm.CdsTtRcvGetAm4.Locate('SEQAM4',fdm.CdsTtRcvGetRt4RSQRT4.AsString,[]);
       fdm.CdsTtRcvGetAm4.Edit();
       Fdm.CdsTtRcvGetAm4BALAM4.AsFloat := Fdm.CdsTtRcvGetAm4TMPAM4.AsFloat + Fdm.CdsTtRcvGetRt4AMTRT4.AsFloat;
       Fdm.CdsTtRcvGetAm4TMPAM4.AsFloat := Fdm.CdsTtRcvGetAm4BALAM4.AsFloat;
       fdm.CdsTtRcvGetAm4.Post();
       fdm.CdsTtRcvGetAm4.Filtered := True;
       fdm.CdsTtRcvGetRt4.Delete();
       CallSumAmtRt4();
    end;
  end;
end;
...
procedure TfrmCsRcvMoneyAdvanceData.BtnDeleteRt4Click(Sender: TObject);
begin
...
procedure TfrmCsRcvMoneyAdvanceData.BtnPrintClick(Sender: TObject);
var Str_Sql : String;
begin
   Str_Sql :='SELECT * FROM SP_REP_RM_RCV_MONEY(' +
              Fdm.CdsTtRcvGetYARRT4.AsString + ',' +
...
procedure TfrmCsRcvMoneyAdvanceData.GetAddr(cno : int64);
begin
...
procedure TfrmCsRcvMoneyAdvanceData.GetAddrAr(cno : String);
begin
  FCarSaledm.CdsMtCsmGetAddr01.Close();
...
procedure TfrmCsRcvMoneyAdvanceData.ArSelected(CNOCM1,TNMCM1,CTPCM1,SMNCM1 : String;CRTAM3 : INTEGER);
begin
...
procedure TfrmCsRcvMoneyAdvanceData.BtnSelectcnoClick(Sender: TObject);
begin
...
procedure TfrmCsRcvMoneyAdvanceData.Init(DM : TDSReceiveMoneyDM; _FG : STRING);
...
begin
  ...
  begin
     ...
     _mm :=  StrToInt(FormatDateTime('mm',Fdm.GetSystemDate));
      ...
      Fdm.CdsTtRcvGetDCDRT4.AsString := DCD;
