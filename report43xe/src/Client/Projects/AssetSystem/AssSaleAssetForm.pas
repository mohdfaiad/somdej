...
type
  TfrmAssSaleAssetGrid = class(TMainGridForm)
    dsgrid: TDataSource;
    UniLabel3: TUniLabel;
...
var
  frmAssSaleAssetGrid: TfrmAssSaleAssetGrid;
...
procedure TfrmAssSaleAssetGrid.btnAddClick(Sender: TObject);
var
  _Form: TUniForm;
begin
