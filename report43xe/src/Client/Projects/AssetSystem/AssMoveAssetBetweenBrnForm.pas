unit AssMoveAssetBetweenBrnForm;
...
type
  TfrmAssMoveAssetBetweenBrnGrid = class(TMainGridForm)
    dsgrid: TDataSource;
    UniLabel3: TUniLabel;
...
var
  frmAssMoveAssetBetweenBrnGrid: TfrmAssMoveAssetBetweenBrnGrid;

implementation

{$R *.dfm}

uses uniGUIForm,AssMoveAssetBetweenBrnDataForm;


procedure TfrmAssMoveAssetBetweenBrnGrid.btnAddClick(Sender: TObject);
var
  _Form: TUniForm;
begin
  _Form := TUniFormClass(TfrmAssMoveAssetBetweenBrnData).Create(UniApplication);
