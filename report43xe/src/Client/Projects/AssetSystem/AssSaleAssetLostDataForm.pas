...
type
  TfrmAssSaleAssetLostData = class(TMainDataForm)
    UniLabel2: TUniLabel;
...
var
  frmAssSaleAssetLostData: TfrmAssSaleAssetLostData;
...
procedure TfrmAssSaleAssetLostData.UniButton1Click(Sender: TObject);
begin
