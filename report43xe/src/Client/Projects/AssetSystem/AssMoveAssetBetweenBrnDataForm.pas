unit AssMoveAssetBetweenBrnDataForm;
...
type
  TfrmAssMoveAssetBetweenBrnData = class(TMainDataForm)
    UniLabel2: TUniLabel;
...
var
  frmAssMoveAssetBetweenBrnData: TfrmAssMoveAssetBetweenBrnData;
...
procedure TfrmAssMoveAssetBetweenBrnData.UniButton1Click(Sender: TObject);
begin
