...
type
  TfrmAssSaleAssetLostGrid = class(TMainGridForm)
    dsgrid: TDataSource;
    UniLabel3: TUniLabel;
...
var
  frmAssSaleAssetLostGrid: TfrmAssSaleAssetLostGrid;

implementation

{$R *.dfm}

uses uniGUIForm, AssSaleAssetLostDataForm;


procedure TfrmAssSaleAssetLostGrid.btnAddClick(Sender: TObject);
var
  _Form: TUniForm;
begin
  _Form := TUniFormClass(TfrmAssSaleAssetLostData).Create(UniApplication);
