inherited frmAssSaleAssetLostData: TfrmAssSaleAssetLostData
  Caption = #3585#3634#3619#3605#3633#3604#3607#3619#3633#3614#3618#3660#3626#3636#3609#3648#3626#3637#3618#3627#3634#3618
  ClientHeight = 650
  ClientWidth = 932
  Position = poDesigned
  ...
  inherited pnBody: TUniPanel
    ...
    object UniDBGrid1: TUniDBGrid
      ...
      Columns = <
        ...
        item
          Title.Alignment = taCenter
          Title.Caption = #3605#3657#3609#3607#3640#3609#3627#3609#3656#3623#3618#3627#3621#3633#3585
          Width = 93
          Visible = True
          Expanded = False
        end
        item
          Title.Alignment = taCenter
          Title.Caption = #3605#3657#3609#3607#3640#3609#3627#3609#3656#3623#3618#3618#3656#3629#3618
          Width = 90
          Visible = True
          Expanded = False
        end
