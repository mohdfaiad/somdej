...
type
  TfrmAssUndefinedAssetGrid = class(TMainGridForm)
    dsgrid: TDataSource;
    UniLabel3: TUniLabel;
...
var
  frmAssUndefinedAssetGrid: TfrmAssUndefinedAssetGrid;

implementation

{$R *.dfm}

uses uniGUIForm, AssUndefinedAssetDataForm;


procedure TfrmAssUndefinedAssetGrid.btnAddClick(Sender: TObject);
var
  _Form: TUniForm;
begin
  _Form := TUniFormClass(TfrmAssUndefinedAssetData).Create(UniApplication);
