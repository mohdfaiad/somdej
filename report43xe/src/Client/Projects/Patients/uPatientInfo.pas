...
type
  TfrmPatientInfo = class(TMainDataForm)//TMainGridForm
    dsgrid: TDataSource;
...
var
  frmTtStockGrid: TfrmPatientInfo;
...
procedure TfrmPatientInfo.ShowData();
var
  _Form: TUniForm;
begin
...
procedure TfrmPatientInfo.btnAddClick(Sender: TObject);
...
procedure TfrmPatientInfo._Confirm(AResult: Integer);
begin
  case AResult of
    mrYes:
      begin
...
procedure TfrmPatientInfo.btnDeleteClick(Sender: TObject);
begin
...
procedure TfrmPatientInfo.btnEditClick(Sender: TObject);
begin
   if (not Fdm.CdsTtStockGet.Active) or
    (Fdm.CdsTtStockGet.IsEmpty) then
  begin
...
procedure TfrmPatientInfo.btnSearchClick(Sender: TObject);
var cirt : String;
begin
  ShowMessage('xxxx');
(*
...
procedure TfrmPatientInfo.BtnViewClick(Sender: TObject);
begin
   if (not Fdm.CdsTtStockGet.Active) or
    (Fdm.CdsTtStockGet.IsEmpty) then
  begin
...
procedure TfrmPatientInfo.dbgDataListTitleClick(Column: TUniDBGridColumn);
begin
...
procedure TfrmPatientInfo.UniFormCreate(Sender: TObject);
begin
...
procedure TfrmPatientInfo.UniFormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  //inherited;
