...
uses
  ...
  uniComboBox, uniDBComboBox, uniDBLookupComboBox, uniRadioButton {$ENDIF};

type
  TfrmTxChangeDocNoWHTGrid = class(TMainGridForm)
    dsgrid: TDataSource;
    UniLabel3: TUniLabel;
    ...
    UniRadioButton3: TUniRadioButton;
...
var
  frmTxChangeDocNoWHTGrid: TfrmTxChangeDocNoWHTGrid;
...
procedure TfrmTxChangeDocNoWHTGrid.btnAddClick(Sender: TObject);
var
  _Form: TUniForm;
begin
