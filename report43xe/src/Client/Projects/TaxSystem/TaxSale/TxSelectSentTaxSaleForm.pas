...
type
  TfrmTxSelectSentTaxSaleGrid = class(TMainGridForm)
    dsgrid: TDataSource;
    UniLabel3: TUniLabel;
...
var
  frmTxSelectSentTaxSaleGrid: TfrmTxSelectSentTaxSaleGrid;
...
procedure TfrmTxSelectSentTaxSaleGrid.btnAddClick(Sender: TObject);
var
  _Form: TUniForm;
begin
