unit SkMoveCarBetweenBrnDataForm;
...
type
  TfrmSkMoveCarBetweenBrnData = class(TMainDataForm)
    dsSt: TDataSource;
    UniLabel9: TUniLabel;
...
var
  frmSkMoveCarBetweenBrnData: TfrmSkMoveCarBetweenBrnData;
...
procedure TfrmSkMoveCarBetweenBrnData.UniButton1Click(Sender: TObject);
begin
  PopupCar.ShowModal;
end;

//initialization
//  RegisterMainFormClass(TfrmSkMoveCarBetweenBrnData);
