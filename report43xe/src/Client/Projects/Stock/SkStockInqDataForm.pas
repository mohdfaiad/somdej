...
type
  TfrmSkStockInqData = class(TMainDataForm)
    dsSt: TDataSource;
    UniLabel9: TUniLabel;
...
var
  frmSkStockInqData: TfrmSkStockInqData;
...
procedure TfrmSkStockInqData.UniButton1Click(Sender: TObject);
begin
  PopupCar.ShowModal;
end;

//initialization
//  RegisterMainFormClass(TfrmSkStockInqData);
