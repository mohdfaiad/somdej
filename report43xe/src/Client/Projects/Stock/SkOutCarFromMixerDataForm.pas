unit SkOutCarFromMixerDataForm;
...
type
  TfrmSkOutCarFromMixerData = class(TMainDataForm)
    dsSt: TDataSource;
    UniLabel9: TUniLabel;
...
var
  frmSkOutCarFromMixerData: TfrmSkOutCarFromMixerData;
...
procedure TfrmSkOutCarFromMixerData.UniButton1Click(Sender: TObject);
begin
  PopupCar.ShowModal;
end;

//initialization
//  RegisterMainFormClass(TfrmSkOutCarFromMixerData);
