...
type
  TfrmSkRcvCarFromComData = class(TMainDataForm)
    dsSt: TDataSource;
    UniLabel9: TUniLabel;
...
var
  frmSkRcvCarFromComData: TfrmSkRcvCarFromComData;
...
procedure TfrmSkRcvCarFromComData.UniButton1Click(Sender: TObject);
begin
  PopupCar.ShowModal;
end;

//initialization
//  RegisterMainFormClass(TfrmSkRcvCarFromComData);
