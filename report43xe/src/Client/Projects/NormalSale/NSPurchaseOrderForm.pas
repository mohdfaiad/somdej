...
type
  TfrmNsPurchaseOrderGrid = class(TMainGridForm)
    dsgrid: TDataSource;
    UniLabel2: TUniLabel;
...
var
  frmNsPurchaseOrderGrid: TfrmNsPurchaseOrderGrid;

implementation

{$R *.dfm}

uses uniGUIForm, NsPurchaseOrderDataForm;


procedure TfrmNsPurchaseOrderGrid.btnAddClick(Sender: TObject);
var
  _Form: TUniForm;
begin
  _Form := TUniFormClass(TfrmNsPurchaseOrderData).Create(UniApplication);
