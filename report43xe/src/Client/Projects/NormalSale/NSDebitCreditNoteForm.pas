...
type
  TfrmNsDebitCreditNoteGrid = class(TMainGridForm)
    dsgrid: TDataSource;
    UniLabel2: TUniLabel;
...
var
  frmNsDebitCreditNoteGrid: TfrmNsDebitCreditNoteGrid;

implementation

{$R *.dfm}

uses uniGUIForm, NsDebitCreditNoteDataForm;


procedure TfrmNsDebitCreditNoteGrid.btnAddClick(Sender: TObject);
var
  _Form: TUniForm;
begin
  _Form := TUniFormClass(TfrmNsSDebitCreditNoteData).Create(UniApplication);
