...
type
  TfrmNsSentOrderData = class(TMainDataForm)
    UniLabel2: TUniLabel;
...
var
  frmNsSentOrderData: TfrmNsSentOrderData;
...
procedure TfrmNsSentOrderData.UniButton1Click(Sender: TObject);
begin
