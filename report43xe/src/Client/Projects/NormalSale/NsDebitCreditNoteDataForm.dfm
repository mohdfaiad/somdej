inherited frmNsSDebitCreditNoteData: TfrmNsSDebitCreditNoteData
  Caption = #3651#3610#3648#3604#3610#3636#3605#3650#3609#3658#3605'/ '#3651#3610#3648#3588#3619#3604#3636#3605#3650#3609#3658#3605
  ClientHeight = 650
  ClientWidth = 931
  Position = poDesigned
  ExplicitWidth = 931
  ...
  inherited pnBody: TUniPanel
    ...
    object UniPanel1: TUniPanel
      ...
      object PnDtl2: TUniPanel
        ...
        object UniComboBox1: TUniComboBox
          ...
          Style = csDropDown
          MaxLength = 0
          Text = #3619#3623#3617#3616#3634#3625#3658
          Items.Strings = (
            #3619#3623#3617#3616#3634#3625#3658
    ...
    object UniDBGrid1: TUniDBGrid
      ...
      Columns = <
        ...
        item
          Title.Alignment = taCenter
          Title.Caption = #3611#3619#3636#3617#3634#3603#3586#3634#3618#3648#3614#3636#3656#3617'/'#3621#3604'<br>'#3627#3609#3656#3623#3618#3627#3621#3633#3585
          Title.Font.Charset = THAI_CHARSET
          Width = 64
          Visible = True
          Alignment = taCenter
        ...
        item
          Title.Alignment = taCenter
          Title.Caption = #3592#3635#3609#3623#3609#3648#3591#3636#3609'<br>'#3651#3610#3585#3635#3585#3633#3610#3616#3634#3625#3637
          Width = 64
          Visible = True
          Expanded = False
        end
  ...
  inherited pnHeader: TUniPanel
    ...
    object UniComboBox2: TUniComboBox
      ...
      Items.Strings = (
        #3611#3619#3633#3610#3611#3619#3640#3591#3619#3634#3588#3634
        #3648#3610#3636#3585#3586#3634#3618#3626#3636#3609#3588#3657#3634)
      ItemIndex = -1
      TabOrder = 13
      RemoteQuery = False
    end
    object UniComboBox3: TUniComboBox
      ...
      Items.Strings = (
        #3611#3619#3633#3610#3611#3619#3640#3591#3619#3634#3588#3634
        #3619#3633#3610#3588#3639#3609#3626#3636#3609#3588#3657#3634)
      ItemIndex = -1
      TabOrder = 14
      RemoteQuery = False
    end
