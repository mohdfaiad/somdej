...
type
  TfrmNsSentNoOrderGrid = class(TMainGridForm)
    dsgrid: TDataSource;
    UniLabel2: TUniLabel;
...
var
  frmNsSentNoOrderGrid: TfrmNsSentNoOrderGrid;

implementation

{$R *.dfm}

uses uniGUIForm, NsSentNoOrderDataForm;


procedure TfrmNsSentNoOrderGrid.btnAddClick(Sender: TObject);
var
  _Form: TUniForm;
begin
  _Form := TUniFormClass(TfrmNsSentNoOrderData).Create(UniApplication);
