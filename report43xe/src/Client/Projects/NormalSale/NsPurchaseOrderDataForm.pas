...
type
  TfrmNsPurchaseOrderData = class(TMainDataForm)
    UniLabel2: TUniLabel;
...
var
  frmNsPurchaseOrderData: TfrmNsPurchaseOrderData;
...
procedure TfrmNsPurchaseOrderData.UniButton1Click(Sender: TObject);
begin
