...
begin
  ...
  fDM.CdsTtPt1GetIDTPT1.AsDateTime := Fdm.GetSystemDate;
  fDM.CdsTtPt1GetRDVPT1.AsDateTime := Fdm.GetSystemDate;
  Fdm.CdsTtPt1GetYARPT1.AsInteger := StrToInt(FormatDateTime('yyyy',Fdm.GetSystemDate));
