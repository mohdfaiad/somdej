inherited frmPsPaymentByAppGrid: TfrmPsPaymentByAppGrid
  Caption = #3588#3657#3609#3627#3634' - '#3651#3610#3626#3635#3588#3633#3597#3592#3656#3634#3618#3648#3594#3655#3588' '#3605#3634#3617#3651#3610#3586#3629#3629#3609#3640#3617#3633#3605#3636#3592#3656#3634#3618
  ClientHeight = 544
  ClientWidth = 927
  ExplicitWidth = 935
  ExplicitHeight = 578
  ...
  inherited pnBody: TUniPanel
    ...
    inherited dbgDataList: TUniDBGrid
      ...
      Columns = <
        ...
        item
          Title.Alignment = taCenter
          Title.Caption = #3608#3609#3634#3588#3634#3619
          Title.Font.Charset = THAI_CHARSET
          Width = 112
          Visible = True
          Expanded = False
        ...
        item
          Title.Alignment = taCenter
          Title.Caption = #3648#3621#3586#3607#3637#3648#3594#3655#3588
          Title.Font.Charset = THAI_CHARSET
          Width = 66
          Visible = True
          Alignment = taCenter
        ...
        item
          Title.Alignment = taCenter
          Title.Caption = #3623#3633#3609#3606#3638#3591#3585#3635#3627#3609#3604#3648#3594#3655#3588
          Width = 90
          Visible = True
          Expanded = False
        end
        item
          Title.Alignment = taCenter
          Title.Caption = #3629#3657#3634#3591#3629#3636#3591#3651#3610#3629#3609#3640#3617#3633#3605#3636#3592#3656#3634#3618
          Width = 129
          Visible = True
          Expanded = False
        end
        item
          Title.Alignment = taCenter
          Title.Caption = #3623#3633#3609#3607#3637#3656#3651#3610#3629#3609#3640#3617#3633#3605#3636
          Width = 97
          Visible = True
          Expanded = False
        end
