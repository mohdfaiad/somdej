unit PsDebitCreditNoteGridForm;
...
type
  TFrmPsDebitCreditNoteGrid = class(TMainGridForm)
    dsgrid: TDataSource;
    UniLabel2: TUniLabel;
...
var
  FrmPsDebitCreditNoteGrid: TFrmPsDebitCreditNoteGrid;

implementation

{$R *.dfm}

uses PsDebitCreditNoteDataForm,uniGUIForm;

procedure TFrmPsDebitCreditNoteGrid.btnAddClick(Sender: TObject);
var
  _Form: TUniForm;
begin
  _Form := TUniFormClass(TfrmPsDebitCreditNoteData).Create(UniApplication);
