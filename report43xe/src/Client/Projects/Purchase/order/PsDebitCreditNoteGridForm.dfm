inherited FrmPsDebitCreditNoteGrid: TFrmPsDebitCreditNoteGrid
  Caption = #3588#3657#3634#3627#3634'-'#3651#3610#3648#3604#3610#3636#3605#3650#3609#3658#3605' / '#3651#3610#3648#3588#3619#3604#3636#3605#3650#3609#3658#3605
  ClientHeight = 578
  ClientWidth = 922
  ExplicitWidth = 930
  ExplicitHeight = 612
  ...
  inherited pnBody: TUniPanel
    ...
    inherited dbgDataList: TUniDBGrid
      ...
      Columns = <
        ...
        item
          Title.Alignment = taCenter
          Title.Caption = #3648#3629#3585#3626#3634#3619#3648#3614#3636#3656#3617#3627#3609#3637#3657
          Title.Font.Charset = THAI_CHARSET
          Width = 106
          Visible = True
          Expanded = False
