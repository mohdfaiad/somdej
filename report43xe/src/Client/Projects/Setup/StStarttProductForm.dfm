inherited frmStStartProductGrid: TfrmStStartProductGrid
  Caption = #3588#3657#3609#3627#3634' -'#3588#3656#3634#3648#3619#3636#3656#3617#3605#3657#3609#3592#3635#3609#3623#3609#3619#3606#3618#3609#3605#3660'/'#3629#3640#3611#3585#3619#3603#3660'/'#3623#3633#3626#3604#3640
  ClientHeight = 515
  ClientWidth = 944
    ...
    inherited dbgDataList: TUniDBGrid
      ...
      Columns = <
        ...
        item
          FieldName = 'ENGIM2'
          Title.Alignment = taCenter
          Title.Caption = #3648#3621#3586#3648#3588#3619#3639#3656#3629#3591#3618#3609#3605#3660
          Title.Font.Charset = THAI_CHARSET
          Width = 133
          Visible = True
          Alignment = taCenter
        ...
        item
          FieldName = 'CT1IM2'
          Title.Alignment = taCenter
          Title.Caption = #3592#3635#3609#3623#3609#3648#3591#3636#3609' '#3627#3609#3656#3623#3618#3627#3621#3633#3585
          Width = 102
          Visible = True
          Alignment = taRightJustify
          Expanded = False
        ...
        item
          FieldName = 'CT2IM2'
          Title.Alignment = taCenter
          Title.Caption = #3592#3635#3609#3623#3609#3648#3591#3636#3609' '#3627#3609#3656#3623#3618#3618#3656#3629#3618
          Width = 105
          Visible = True
          Alignment = taRightJustify
          Expanded = False
