unit StTargetByProductDataForm;
...
type
  TfrmStTargetByProductData = class(TMainDataForm)
    dsgrid: TDataSource;
...
var
  frmStTargetByProductData: TfrmStTargetByProductData;
...
procedure TfrmStTargetByProductData.checkCur(Sender: TObject;CdsTmp : TClientDataSet);
var
  cur : Currency;
  F: TField;
  Str,Tmp : String;
...
procedure TfrmStTargetByProductData.ShowBg();
begin
...
procedure TfrmStTargetByProductData.A01BG2Exit(Sender: TObject);
begin
  checkCur(A01BG2,Fdm.CdsStBgGet);

end;

procedure TfrmStTargetByProductData.A02BG2Exit(Sender: TObject);
begin
  checkCur(A02BG2,Fdm.CdsStBgGet);

end;

procedure TfrmStTargetByProductData.A03BG2Exit(Sender: TObject);
begin
  checkCur(A03BG2,Fdm.CdsStBgGet);

end;

procedure TfrmStTargetByProductData.A04BG2Exit(Sender: TObject);
begin
  checkCur(A04BG2,Fdm.CdsStBgGet);

end;

procedure TfrmStTargetByProductData.A05BG2Exit(Sender: TObject);
begin
  checkCur(A05BG2,Fdm.CdsStBgGet);

end;

procedure TfrmStTargetByProductData.A06BG2Exit(Sender: TObject);
begin
  checkCur(A06BG2,Fdm.CdsStBgGet);

end;

procedure TfrmStTargetByProductData.A07BG2Exit(Sender: TObject);
begin
  checkCur(A07BG2,Fdm.CdsStBgGet);

end;

procedure TfrmStTargetByProductData.A08BG2Exit(Sender: TObject);
begin
  checkCur(A08BG2,Fdm.CdsStBgGet);

end;

procedure TfrmStTargetByProductData.A09BG2Exit(Sender: TObject);
begin
  checkCur(A09BG2,Fdm.CdsStBgGet);

end;

procedure TfrmStTargetByProductData.A10BG2Exit(Sender: TObject);
begin
  checkCur(A10BG2,Fdm.CdsStBgGet);

end;

procedure TfrmStTargetByProductData.A11BG2Exit(Sender: TObject);
begin
  checkCur(A11BG2,Fdm.CdsStBgGet);

end;

procedure TfrmStTargetByProductData.A12BG2Exit(Sender: TObject);
begin
  checkCur(A12BG2,Fdm.CdsStBgGet);

end;

procedure TfrmStTargetByProductData.btnCancelClick(Sender: TObject);
begin
...
procedure TfrmStTargetByProductData.btnConfirmClick(Sender: TObject);
var ch ,Ch2: Boolean;
  md : String;
begin
...
procedure TfrmStTargetByProductData.ContractSelected(ITNPM1,TNMPM1: String;UC1PM1,UC2PM1,UP1PM1,FAMPM1: DOUBLE);
begin
...
procedure TfrmStTargetByProductData.BtnSelectProductClick(Sender: TObject);
begin
...
procedure TfrmStTargetByProductData.Init(DM : TDSSetupDM);
begin
  Fdm := Dm;
...
//initialization
//  RegisterMainFormClass(TfrmStTargetByProductData);
