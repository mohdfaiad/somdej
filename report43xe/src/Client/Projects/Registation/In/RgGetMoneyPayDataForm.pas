...
type
  TfrmRgGetMoneyPayData = class(TMainDataForm)
    UniLabel2: TUniLabel;
...
var
  frmRgGetMoneyPayData: TfrmRgGetMoneyPayData;
...
procedure TfrmRgGetMoneyPayData.UniButton1Click(Sender: TObject);
begin
