...
type
  TfrmRgSentMoneyPayGrid = class(TMainGridForm)
    dsgrid: TDataSource;
    UniLabel2: TUniLabel;
...
var
  frmRgSentMoneyPayGrid: TfrmRgSentMoneyPayGrid;

implementation

{$R *.dfm}

uses uniGUIForm, RgSentMoneyPayDataForm;


procedure TfrmRgSentMoneyPayGrid.btnAddClick(Sender: TObject);
var
  _Form: TUniForm;
begin
  _Form := TUniFormClass(TfrmRgSentMoneyPayData).Create(UniApplication);
