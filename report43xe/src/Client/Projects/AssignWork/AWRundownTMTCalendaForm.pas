...
type
  TfrmAWRundownTMTCalendaGrid = class(TMainGridForm)
    dsgrid: TDataSource;
    LbCid: TUniLabel;
    EdtYar: TUniEdit;
    UniLabel2: TUniLabel;
...
var
  frmAWRundownTMTCalendaGrid: TfrmAWRundownTMTCalendaGrid;
...
uses uniGUIForm, StDtlCodeForm, PopupStDtlCodeForm,
  XeUniGUIComponents,PopupStHdrCodeForm, ServerModuleEx, AWRundownTMTForm;

procedure TfrmAWRundownTMTCalendaGrid.SetTrue();
var
  I: Integer;
begin
...
procedure TfrmAWRundownTMTCalendaGrid.SundayDate(dd : integer);
var
  I: Integer;
  StrDD : String;
begin
...
procedure TfrmAWRundownTMTCalendaGrid.MoreLastDayVisible(dd : integer);
var
  I: Integer;
  StrDD : String;
begin
...
procedure TfrmAWRundownTMTCalendaGrid.SetWeekColore(dd : integer;cl : TColor;Grp : integer);
var
  I: Integer;
  StrDD : String;
begin
...
procedure TfrmAWRundownTMTCalendaGrid.CheckSunday(FromDate,ToDate : TDateTime);
var  Y, M, D: Word;
     mm : String;
begin
...
procedure TfrmAWRundownTMTCalendaGrid.SetDataButton(BtnName ,Mem:String;OPTOPT : STRING);
var
  I: Integer;
begin
...
procedure TfrmAWRundownTMTCalendaGrid.SelectDataButton();
begin
...
procedure TfrmAWRundownTMTCalendaGrid.BTClick(var BT : TUniSpeedButton);
begin
...
procedure TfrmAWRundownTMTCalendaGrid.SelectButton(Answer:integer ;BtnName ,md:String );
var
  I: Integer;
begin
...
procedure TfrmAWRundownTMTCalendaGrid.BT0101Click(Sender: TObject);
var
  _Form: TUniForm;
  _Date : TDateTime;
  Yar,Prd : integer;
begin
  ...
  begin
    ...
    exit;
      ...
      _Form := TUniFormClass(TfrmAWRundownTMTGrid).Create(UniApplication);
      TfrmAWRundownTMTGrid(_Form).Init(FDM,_Date,TUniSpeedButton(Sender).GroupIndex);
...
procedure TfrmAWRundownTMTCalendaGrid.btnSearchClick(Sender: TObject);
begin
...
procedure TfrmAWRundownTMTCalendaGrid.dbgDataListTitleClick(Column: TUniDBGridColumn);
begin
...
Procedure TfrmAWRundownTMTCalendaGrid.loadCaption(mm : integer);
...
procedure TfrmAWRundownTMTCalendaGrid.ShowCarlenda();
var D, M, Y : WORD;
  i ,max: integer;
begin
...
procedure TfrmAWRundownTMTCalendaGrid.UniFormCreate(Sender: TObject);
begin
