unit AWAssignNoWeekCalendaForm;
...
type
  TfrmAWAssignNoWeekCalendaGrid = class(TMainGridForm)
    dsgrid: TDataSource;
    LbCid: TUniLabel;
    EdtYar: TUniEdit;
    UniLabel2: TUniLabel;
...
var
  frmAWAssignNoWeekCalendaGrid: TfrmAWAssignNoWeekCalendaGrid;
...
procedure TfrmAWAssignNoWeekCalendaGrid.SetTrue();
var
  I: Integer;
begin
...
procedure TfrmAWAssignNoWeekCalendaGrid.SundayDate(dd : integer);
var
  I: Integer;
  StrDD : String;
begin
...
procedure TfrmAWAssignNoWeekCalendaGrid.MoreLastDayVisible(dd : integer);
var
  I: Integer;
  StrDD : String;
begin
...
procedure TfrmAWAssignNoWeekCalendaGrid.SetWeekColore(dd : integer;cl : TColor;Grp : integer);
var
  I: Integer;
  StrDD : String;
begin
...
procedure TfrmAWAssignNoWeekCalendaGrid.CheckSunday(FromDate,ToDate : TDateTime);
var  Y, M, D: Word;
     mm : String;
begin
...
procedure TfrmAWAssignNoWeekCalendaGrid.SetDataButton(BtnName ,Mem:String;OPTOPT : STRING);
var
  I: Integer;
begin
...
procedure TfrmAWAssignNoWeekCalendaGrid.SelectDataButton();
begin
...
procedure TfrmAWAssignNoWeekCalendaGrid.BTClick(var BT : TUniSpeedButton);
begin
...
procedure TfrmAWAssignNoWeekCalendaGrid.SelectButton(Answer:integer ;BtnName ,md:String );
var
  I: Integer;
begin
...
procedure TfrmAWAssignNoWeekCalendaGrid.BT0101Click(Sender: TObject);
var
  _Form: TUniForm;
  _Date : TDateTime;
  Yar,Prd : integer;
begin
  ...
  begin
    ...
    exit;
      ...
      _Form := TUniFormClass(TfrmAWAssignNoWeekGrid).Create(UniApplication);
      TfrmAWAssignNoWeekGrid(_Form).Init(FDM,_Date,TUniSpeedButton(Sender).GroupIndex);
...
procedure TfrmAWAssignNoWeekCalendaGrid.btnSearchClick(Sender: TObject);
begin
...
procedure TfrmAWAssignNoWeekCalendaGrid.dbgDataListTitleClick(Column: TUniDBGridColumn);
begin
...
Procedure TfrmAWAssignNoWeekCalendaGrid.loadCaption(mm : integer);
...
procedure TfrmAWAssignNoWeekCalendaGrid.ShowCarlenda();
var D, M, Y : WORD;
  i ,max: integer;
begin
...
procedure TfrmAWAssignNoWeekCalendaGrid.UniFormCreate(Sender: TObject);
begin
