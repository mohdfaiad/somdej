...
type
  TfrmAWAssignWeekCalendaGrid = class(TMainGridForm)
    dsgrid: TDataSource;
    LbCid: TUniLabel;
    EdtYar: TUniEdit;
    UniLabel2: TUniLabel;
...
var
  frmAWAssignWeekCalendaGrid: TfrmAWAssignWeekCalendaGrid;
...
uses uniGUIForm, StDtlCodeForm, PopupStDtlCodeForm,
  ...
  PopupAssignWeekForm, AWAssignWeekForm;

procedure TfrmAWAssignWeekCalendaGrid.SetTrue();
var
  I: Integer;
begin
...
procedure TfrmAWAssignWeekCalendaGrid.SundayDate(dd : integer);
var
  I: Integer;
  StrDD : String;
begin
...
procedure TfrmAWAssignWeekCalendaGrid.MoreLastDayVisible(dd : integer);
var
  I: Integer;
  StrDD : String;
begin
...
procedure TfrmAWAssignWeekCalendaGrid.SetWeekColore(dd : integer;cl : TColor;Grp : integer);
var
  I: Integer;
  StrDD : String;
begin
...
procedure TfrmAWAssignWeekCalendaGrid.CheckSunday(FromDate,ToDate : TDateTime);
var  Y, M, D: Word;
     mm : String;
begin
...
procedure TfrmAWAssignWeekCalendaGrid.SetDataButton(BtnName ,Mem:String;OPTOPT : STRING);
var
  I: Integer;
begin
...
procedure TfrmAWAssignWeekCalendaGrid.SelectDataButton();
begin
...
procedure TfrmAWAssignWeekCalendaGrid.BTClick(var BT : TUniSpeedButton);
begin
...
procedure TfrmAWAssignWeekCalendaGrid.SelectButton(Answer:integer ;BtnName ,md:String );
var
  I: Integer;
begin
...
procedure TfrmAWAssignWeekCalendaGrid.BT0101Click(Sender: TObject);
var
  _Form: TUniForm;
  _Date : TDateTime;
  Yar,Prd : integer;
begin
  ...
  begin
    ...
    exit;
      ...
      _Form := TUniFormClass(TfrmAWAssignWeekGrid).Create(UniApplication);
      TfrmAWAssignWeekGrid(_Form).Init(FDM,_Date,TUniSpeedButton(Sender).GroupIndex);
...
procedure TfrmAWAssignWeekCalendaGrid.btnSearchClick(Sender: TObject);
begin
...
procedure TfrmAWAssignWeekCalendaGrid.dbgDataListTitleClick(Column: TUniDBGridColumn);
begin
...
Procedure TfrmAWAssignWeekCalendaGrid.loadCaption(mm : integer);
...
procedure TfrmAWAssignWeekCalendaGrid.ShowCarlenda();
var D, M, Y : WORD;
  i ,max: integer;
begin
...
procedure TfrmAWAssignWeekCalendaGrid.UniFormCreate(Sender: TObject);
begin
