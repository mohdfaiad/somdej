...
type
  TfrmTaOrderColorGrid = class(TMainGridForm)
    dsgrid: TDataSource;
    UniLabel3: TUniLabel;
    UniLabel2: TUniLabel;
...
var
  frmTaOrderColorGrid: TfrmTaOrderColorGrid;

implementation

{$R *.dfm}

uses uniGUIForm, TaOrderColorDataForm;


procedure TfrmTaOrderColorGrid.btnAddClick(Sender: TObject);
var
  _Form: TUniForm;
begin
  _Form := TUniFormClass(TfrmTaOrderColorData).Create(UniApplication);
