...
type
  TfrmAWAssignOutCalendaGrid = class(TMainGridForm)
    dsgrid: TDataSource;
    LbCid: TUniLabel;
    EdtYar: TUniEdit;
    UniLabel2: TUniLabel;
...
var
  frmAWAssignOutCalendaGrid: TfrmAWAssignOutCalendaGrid;
...
uses uniGUIForm, StDtlCodeForm, PopupStDtlCodeForm,
  ...
  PopupOrderColForm, AWAssignOutForm;

procedure TfrmAWAssignOutCalendaGrid.SetTrue();
var
  I: Integer;
begin
...
procedure TfrmAWAssignOutCalendaGrid.SundayDate(dd : integer);
var
  I: Integer;
  StrDD : String;
begin
...
procedure TfrmAWAssignOutCalendaGrid.MoreLastDayVisible(dd : integer);
var
  I: Integer;
  StrDD : String;
begin
...
procedure TfrmAWAssignOutCalendaGrid.SetWeekColore(dd : integer;cl : TColor;Grp : integer);
var
  I: Integer;
  StrDD : String;
begin
...
procedure TfrmAWAssignOutCalendaGrid.CheckSunday(FromDate,ToDate : TDateTime);
var  Y, M, D: Word;
     mm : String;
begin
...
procedure TfrmAWAssignOutCalendaGrid.SetDataButton(BtnName ,Mem:String;OPTOPT : STRING);
var
  I: Integer;
begin
...
procedure TfrmAWAssignOutCalendaGrid.SelectDataButton();
begin
...
procedure TfrmAWAssignOutCalendaGrid.BTClick(var BT : TUniSpeedButton);
begin
...
procedure TfrmAWAssignOutCalendaGrid.SelectButton(Answer:integer ;BtnName ,md:String );
var
  I: Integer;
begin
...
procedure TfrmAWAssignOutCalendaGrid.BT0101Click(Sender: TObject);
var
  _Form: TUniForm;
  _Date : TDateTime;
  Yar,Prd ,Week: integer;

begin
   Yar := Fdm.CdsTtSchGetYARSCH.AsInteger;
   Prd := Fdm.CdsTtSchGetPRDSCH.AsInteger;
   week := TUniSpeedButton(Sender).GroupIndex;
  ...
  begin
    ...
    exit;
      ...
      _Form := TUniFormClass(TfrmAWAssignOutGrid).Create(UniApplication);
      TfrmAWAssignOutGrid(_Form).Init(FDM,_Date,week);
...
procedure TfrmAWAssignOutCalendaGrid.btnSearchClick(Sender: TObject);
begin
...
procedure TfrmAWAssignOutCalendaGrid.dbgDataListTitleClick(Column: TUniDBGridColumn);
begin
...
Procedure TfrmAWAssignOutCalendaGrid.loadCaption(mm : integer);
...
procedure TfrmAWAssignOutCalendaGrid.ShowCarlenda();
var D, M, Y : WORD;
  i ,max: integer;
begin
...
procedure TfrmAWAssignOutCalendaGrid.UniFormCreate(Sender: TObject);
begin
