...
type
  TfrmTaAssignPersonalGrid = class(TMainGridForm)
    dsgrid: TDataSource;
    UniLabel3: TUniLabel;
    UniLabel2: TUniLabel;
...
var
  frmTaAssignPersonalGrid: TfrmTaAssignPersonalGrid;

implementation

{$R *.dfm}

uses uniGUIForm, TaAssignPersonalDataForm;


procedure TfrmTaAssignPersonalGrid.btnAddClick(Sender: TObject);
var
  _Form: TUniForm;
begin
  _Form := TUniFormClass(TfrmTaAssignPersonalData).Create(UniApplication);
