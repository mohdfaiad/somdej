...
type
  TfrmTaOrderColorData = class(TMainDataForm)
    UniLabel2: TUniLabel;
...
var
  frmTaOrderColorData: TfrmTaOrderColorData;
...
procedure TfrmTaOrderColorData.UniButton1Click(Sender: TObject);
begin
