...
type
  TfrmTaAssignPersonalData = class(TMainDataForm)
    UniLabel2: TUniLabel;
...
var
  frmTaAssignPersonalData: TfrmTaAssignPersonalData;
...
procedure TfrmTaAssignPersonalData.UniButton1Click(Sender: TObject);
begin
