unit AWAssignPersonalCalendaForm;
...
type
  TfrmAWAssignPersonalCalendaGrid = class(TMainGridForm)
    dsgrid: TDataSource;
    LbCid: TUniLabel;
    EdtYar: TUniEdit;
    UniLabel2: TUniLabel;
...
var
  frmAWAssignPersonalCalendaGrid: TfrmAWAssignPersonalCalendaGrid;
...
uses uniGUIForm, StDtlCodeForm, PopupStDtlCodeForm,
  ...
  PopupOrderColForm, AWAssignPersonalForm;

procedure TfrmAWAssignPersonalCalendaGrid.SetTrue();
var
  I: Integer;
begin
...
procedure TfrmAWAssignPersonalCalendaGrid.SundayDate(dd : integer);
var
  I: Integer;
  StrDD : String;
begin
...
procedure TfrmAWAssignPersonalCalendaGrid.MoreLastDayVisible(dd : integer);
var
  I: Integer;
  StrDD : String;
begin
...
procedure TfrmAWAssignPersonalCalendaGrid.SetWeekColore(dd : integer;cl : TColor;Grp : integer);
var
  I: Integer;
  StrDD : String;
begin
...
procedure TfrmAWAssignPersonalCalendaGrid.CheckSunday(FromDate,ToDate : TDateTime);
var  Y, M, D: Word;
     mm : String;
begin
...
procedure TfrmAWAssignPersonalCalendaGrid.SetDataButton(BtnName ,Mem:String;OPTOPT : STRING);
var
  I: Integer;
begin
...
procedure TfrmAWAssignPersonalCalendaGrid.SelectDataButton();
begin
...
procedure TfrmAWAssignPersonalCalendaGrid.BTClick(var BT : TUniSpeedButton);
begin
...
procedure TfrmAWAssignPersonalCalendaGrid.SelectButton(Answer:integer ;BtnName ,md:String );
var
  I: Integer;
begin
...
procedure TfrmAWAssignPersonalCalendaGrid.BT0101Click(Sender: TObject);
var
  _Form: TUniForm;
  _Date : TDateTime;
  Yar,Prd : integer;
begin
  ...
  begin
    ...
    exit;
      ...
      _Form := TUniFormClass(TfrmAWAssignPersonalGrid).Create(UniApplication);
      TfrmAWAssignPersonalGrid(_Form).Init(FDM,_Date,TUniSpeedButton(Sender).GroupIndex);
...
procedure TfrmAWAssignPersonalCalendaGrid.btnSearchClick(Sender: TObject);
begin
...
procedure TfrmAWAssignPersonalCalendaGrid.dbgDataListTitleClick(Column: TUniDBGridColumn);
begin
...
Procedure TfrmAWAssignPersonalCalendaGrid.loadCaption(mm : integer);
...
procedure TfrmAWAssignPersonalCalendaGrid.ShowCarlenda();
var D, M, Y : WORD;
  i ,max: integer;
begin
...
procedure TfrmAWAssignPersonalCalendaGrid.UniFormCreate(Sender: TObject);
begin
