...
type
  TfrmAWPreAssignCalendaGrid = class(TMainGridForm)
    dsgrid: TDataSource;
    LbCid: TUniLabel;
    EdtYar: TUniEdit;
    UniLabel2: TUniLabel;
...
var
  frmAWPreAssignCalendaGrid: TfrmAWPreAssignCalendaGrid;
...
procedure TfrmAWPreAssignCalendaGrid.SetTrue();
var
  I: Integer;
begin
...
procedure TfrmAWPreAssignCalendaGrid.SundayDate(dd : integer);
var
  I: Integer;
  StrDD : String;
begin
...
procedure TfrmAWPreAssignCalendaGrid.MoreLastDayVisible(dd : integer);
var
  I: Integer;
  StrDD : String;
begin
...
procedure TfrmAWPreAssignCalendaGrid.SetWeekColore(dd : integer;cl : TColor;Grp : integer);
var
  I: Integer;
  StrDD : String;
begin
...
procedure TfrmAWPreAssignCalendaGrid.CheckSunday(FromDate,ToDate : TDateTime);
var  Y, M, D: Word;
     mm : String;
begin
...
procedure TfrmAWPreAssignCalendaGrid.SetDataButton(BtnName ,Mem:String;OPTOPT : STRING);
var
  I: Integer;
begin
...
procedure TfrmAWPreAssignCalendaGrid.SelectDataButton();
begin
...
procedure TfrmAWPreAssignCalendaGrid.BTClick(var BT : TUniSpeedButton);
begin
...
procedure TfrmAWPreAssignCalendaGrid.SelectButton(Answer:integer ;BtnName ,md:String );
var
  I: Integer;
begin
...
procedure TfrmAWPreAssignCalendaGrid.BT0101Click(Sender: TObject);
var
  _Form: TUniForm;
  _Date : TDateTime;
  Yar,Prd : integer;
begin
  ...
  begin
    ...
    exit;
      ...
      _Form := TUniFormClass(TfrmAWPreAssignGrid).Create(UniApplication);
      TfrmAWPreAssignGrid(_Form).Init(FDM,_Date,TUniSpeedButton(Sender).GroupIndex);
...
procedure TfrmAWPreAssignCalendaGrid.btnSearchClick(Sender: TObject);
begin
...
procedure TfrmAWPreAssignCalendaGrid.dbgDataListTitleClick(Column: TUniDBGridColumn);
begin
...
Procedure TfrmAWPreAssignCalendaGrid.loadCaption(mm : integer);
...
procedure TfrmAWPreAssignCalendaGrid.ShowCarlenda();
var D, M, Y : WORD;
  i ,max: integer;
begin
...
procedure TfrmAWPreAssignCalendaGrid.UniFormCreate(Sender: TObject);
begin
